...
@Service
public class MqServiceOneImpl implements MqServiceOne, InitializingBean, DisposableBean {

    protected org.slf4j.Logger logger = LoggerFactory.getLogger(MqServiceOneImpl.class);
    //地址
