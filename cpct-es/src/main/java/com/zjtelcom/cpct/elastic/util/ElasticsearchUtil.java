...
public class ElasticsearchUtil {
    ...
    public static boolean  updateMapping(String index) {
    ...
    public static String createIndexWithMapping(String index) throws IOException {
        if (isIndexExist(index)){
            return "index is exits";
        }
        Settings.Builder builder=Settings.builder()
                .put("number_of_replicas", 1)
                .put("number_of_shards",3).put("refresh_interval", "20s");
        ...
        client.admin().indices().prepareCreate(index).
                setSettings(builder).addMapping(index,xContentBuilder).execute().actionGet();
        return "OK";
