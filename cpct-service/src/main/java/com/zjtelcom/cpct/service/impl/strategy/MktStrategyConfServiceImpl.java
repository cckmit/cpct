...
public class MktStrategyConfServiceImpl extends BaseService implements MktStrategyConfService {
    ...
    public Map<String, Object> saveMktStrategyConf(MktStrategyConfDetail mktStrategyConfDetail) throws Exception {
        ...
        try {
            ...
            //保存策略与过滤规则关系
            if (mktStrategyConfDetail.getFilterRuleList() != null && mktStrategyConfDetail.getFilterRuleList().size() > 0) {
                for (Long FilterRuleId : mktStrategyConfDetail.getFilterRuleList()) {
    ...
    public Map<String, Object> getMktStrategyConf(Long mktStrategyConfId) throws Exception {
        ...
        try {
            ...
            // 获取过滤规则集合
            List<Long> filterRuleList = mktStrategyFilterRuleRelMapper.selectByStrategyId(mktStrategyConfId);
            mktStrategyConfDetail.setFilterRuleList(filterRuleList);
