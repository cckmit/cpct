...
public interface MktCampaignMapper {
    ...
    List<MktCampaignDO> selectCampaignThemeByC3(@Param("value") String value, @Param("startDate") String startDate,@Param("endDate") String endDate,@Param("type") String type,@Param("c3") String c3,@Param("regionFlg")String regionFlg);

    Integer getCountFromActivityTheme(@Param("date") String date,@Param("type") String type,@Param("start")String start);

    Integer getCountFromActivityThemeByC3(@Param("startDate") String startDate,@Param("type") String type,@Param("endDate")String endDate,@Param("c3") String c3, @Param("regionFlg")String regionFlg);
