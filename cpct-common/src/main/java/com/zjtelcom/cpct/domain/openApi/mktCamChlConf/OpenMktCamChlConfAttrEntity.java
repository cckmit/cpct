...
public class OpenMktCamChlConfAttrEntity {
    ...
    public String getAttrValueNbr() {
        return attrValueNbr;
    }

    public void setAttrValueNbr(String attrValueNbr) {
        this.attrValueNbr = attrValueNbr;
    }
