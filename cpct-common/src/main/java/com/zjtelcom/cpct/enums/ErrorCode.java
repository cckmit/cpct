...
public enum ErrorCode {
    ...
    STATUS_CODE_CHECKING_SUCCESS("活动提交审核成功！", "00001"),
    STATUS_CODE_CHECKING_FAILURE("活动提交审核失败！", "00001"),

    STATUS_CODE_PUBLISHED_SUCCESS("活动发布成功！", "00001"),
    STATUS_CODE_PUBLISHED_FAILURE("活动发布失败！", "00001"),

    STATUS_CODE_STOP_SUCCESS("活动暂停成功！", "00001"),
    STATUS_CODE_STOP_FAILURE("活动暂停失败！", "00001"),

    STATUS_CODE_PASS_SUCCESS("活动审核成功！", "00001"),
    STATUS_CODE_PASS_FAILURE("活动审核失败！", "00001"),

    STATUS_CODE_ROLL_SUCCESS("活动下线成功！", "00001"),
    STATUS_CODE_ROLL_FAILURE("活动下线失败！", "00001"),


    SAVE_MKT_CAMPAIGN_SUCCESS("活动保存成功！", "00001"),
    SAVE_MKT_CAMPAIGN_FAILURE("活动保存失败！", "00001"),
    UPDATE_MKT_CAMPAIGN_SUCCESS("活动修改成功！", "00001"),
    UPDATE_MKT_CAMPAIGN_FAILURE("活动修改失败！", "00001"),
    GET_MKT_CAMPAIGN_SUCCESS("活动查看成功！", "00001"),
    GET_MKT_CAMPAIGN_FAILURE("活动查看失败！", "00001"),
    DELETE_MKT_CAMPAIGN_SUCCESS("活动删除成功！", "00001"),
    DELETE_MKT_CAMPAIGN_FAILURE("活动删除失败！", "00001"),

    SAVE_MKT_STR_CONF_SUCCESS("添加策略配置成功！", "00001"),
    SAVE_MKT_STR_CONF_FAILURE("添加策略配置失败！", "00001"),
    UPDATE_MKT_STR_CONF_SUCCESS("修改策略配置成功！", "00001"),
    UPDATE_MKT_STR_CONF_FAILURE("修改策略配置失败！", "00001"),
    GET_MKT_STR_CONF_SUCCESS("获取策略配置成功！", "00001"),
    GET_MKT_STR_CONF_FAILURE("获取策略配置失败！", "00001"),
    DELETE_MKT_STR_CONF_SUCCESS("删除策略配置成功！", "00001"),
    DELETE_MKT_STR_CONF_FAILURE("删除策略配置失败！", "00001"),
    ...
    SAVE_MKT_CAM_CHL_CONF_FAILURE("添加二次协同结果失败！", "00001"),
    GET_MKT_CAM_CHL_CONF_FAILURE("删除二次协同结果失败！", "00001"),
    DELETE_MKT_CAM_CHL_CONF_FAILURE("删除二次协同结果失败！", "00001");
/*    SAVE_MKT_RULE_STR_CONF_RULE_FAILURE("添加策略规则失败！", "00001"),
    UPDATE_MKT_RULE_STR_CONF_RULE_SUCCESS("修改策略规则成功！", "00001"),
    UPDATE_MKT_RULE_STR_CONF_RULE_FAILURE("修改策略规则失败！", "00001"),
    GET_MKT_RULE_STR_CONF_RULE_SUCCESS("获取策略规则成功！", "00001"),
