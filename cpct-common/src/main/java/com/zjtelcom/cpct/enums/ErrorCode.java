...
public enum ErrorCode {
    ...
    SAVE_MKT_CAMPAIGN_SUCCESS("保存活动成功！", "00001"),
    SAVE_MKT_CAMPAIGN_FAILURE("保存活动失败！", "00001"),
    UPDATE_MKT_CAMPAIGN_SUCCESS("修改活动成功！", "00001"),
    UPDATE_MKT_CAMPAIGN_FAILURE("修改活动失败！", "00001"),
    GET_MKT_CAMPAIGN_SUCCESS("查看活动成功！", "00001"),
    GET_MKT_CAMPAIGN_FAILURE("查看活动失败！", "00001"),
    DELETE_MKT_CAMPAIGN_SUCCESS("删除活动成功！", "00001"),
    DELETE_MKT_CAMPAIGN_FAILURE("删除活动失败！", "00001"),
