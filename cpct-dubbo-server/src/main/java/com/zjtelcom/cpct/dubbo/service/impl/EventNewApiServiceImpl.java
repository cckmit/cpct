...
//import com.zjtelcom.cpct.dubbo.service.EventNewApiService;
...
//
//@Service
//public class EventNewApiServiceImpl implements EventNewApiService {
//
//    @Value("${thread.maxPoolSize}")
//    private int maxPoolSize;
//
//    private static final Logger log = LoggerFactory.getLogger(EventNewApiServiceImpl.class);
//
//    @Autowired
...
//                        isAllAsset = false;
//                    } else if ((Integer) activeMap.get("levelConfig") == 0){  // 0为客户级
//                        isAllAsset = true;
//                    }
//                }
//
