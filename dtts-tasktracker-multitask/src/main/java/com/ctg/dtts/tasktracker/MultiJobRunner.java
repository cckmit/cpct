...
//import com.ctzj.smt.bss.customer.persist.dao.OfferInstDao;
//import com.ctzj.smt.bss.customer.write.service.api.IOfferInstExpService;
...
//    }
    ...
    public void runCampaignCycleMonth() throws Throwable { //不带Job job参数、没有返回，适用于无参数无返回的任务
        try {
            ...
            LOGGER.info("Run CampaignCycleMonth failed!", e);
        }
    }
    ...
    public void runCampaignCycleWeek() throws Throwable { //不带Job job参数、没有返回，适用于无参数无返回的任务
        try {
            ...
            LOGGER.info("Run CampaignCycleWeek failed!", e);
        }
    }
